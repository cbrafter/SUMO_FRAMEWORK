...
class actuatedControl(signalControl.signalControl):
    ...
    def process(self):
        ...
        if isControlInterval:
            ...
            #     pass
                ...
                # Before the period of the next stage (not finished)
                pass
            else:
                # Not active, not in offset, stage finished, loop stages
    ...
    def getNextStage(self):
        waiting = [np.any(self._getLaneDetectTime(x) < self.threshold) for x in range(self.Nstages)]
