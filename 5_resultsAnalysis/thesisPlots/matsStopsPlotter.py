...
modLim = {'sellyOak_lo':{False:[[0, 6], 0.5], True:[[0, 6.5], 0.5]},
          'sellyOak_avg':{False:[[0, 7], 0.5], True:[[0, 13.25], 1]},
          'sellyOak_hi':{False:[[0, 11], 1], True:[[0, 40], 5]}}
...
pdfFileName = 'MATS_stops{}.pdf'.format(pedString)
...
'''
Crop out legend:
pdfcrop --margins '0 0 0 -580' delay.pdf legend_crop.pdf
