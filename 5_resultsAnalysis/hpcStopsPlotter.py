...
pdfFileName = 'stops{}.pdf'.format(pedString)
...
for model in models:
    ...
    for controller in controllers:
        ...
        # get mean stops across all runs
    ...
    # After buliding all plots, format and save figure 
    ...
    yMin, yMax = min(ylocs), max(ylocs)
    yDelta = 0.5
    # double the ytick interval
    newYticks = np.arange(0, yMax+(0.5*yDelta), yDelta, dtype=float)
