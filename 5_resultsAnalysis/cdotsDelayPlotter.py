...
modLimLog = {'sellyOak_avg':{False:[[10, 10**4], 0], True:[[10, 10**4], 0]},
             'sellyOak_lo':{False:[[8, 10**3], 0], True:[[10, 10**3], 0]},
...
for model in models:
    ...
    #plt.yticks(np.arange(yMin, yMax+1, modLim[model][pedStage][1], dtype=int))
    plt.yscale('log')
